...
def test_ex1_2():
    ...
    '''
    directory = 'ex1/B'
    expected =  [('ex1/B/NTeiT/EZDOA.txt', 11), 
                 ('ex1/B/OkUCm/MnoZY/AgwDD.txt', 13), 
                 ('ex1/B/XNbrp/nSlKw/IDpRs.txt', 15), 
                 ('ex1/B/XNbrp/fqAXO/GTFET.txt', 17), 
                 ('ex1/B/NTeiT/EdwAG.txt', 19), 
                 ('ex1/B/NTeiT/rwbme/eBCxC.txt', 19), 
                 ('ex1/B/OkUCm/MnoZY/RhPfc.txt', 19), 
                 ('ex1/B/OkUCm/RpnHv/zvNoP.txt', 19), 
                 ('ex1/B/OkUCm/jPNex.txt', 19), 
                 ('ex1/B/OkUCm/sNMOc/eIkqL.txt', 19), 
                 ('ex1/B/XNbrp/XOsqY/AdpBA.txt', 19), 
                 ('ex1/B/XNbrp/XOsqY/JVXTq.txt', 19), 
                 ('ex1/B/XNbrp/nSlKw/CPynp.txt', 19), 
                 ('ex1/B/XNbrp/nSlKw/npcaf.txt', 19)]
    return do_test_ex1(directory, expected)
